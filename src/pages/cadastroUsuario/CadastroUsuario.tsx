    ...
    return (
        <Grid container direction='row' justifyContent='center' alignItems='center'>
            ...
            <Grid item xs={12} md={6} alignItems='center'>
                <Box paddingX={10} paddingY={{ xs: 5 }}>
                    <form onSubmit={onSubmit}>
                        <Typography variant='h3' gutterBottom color='textPrimary' component='h3' align='center' className='textos2'>Cadastrar</Typography>

                        <TextField value={user.nome} required onChange={(e: ChangeEvent<HTMLInputElement>) => updatedModel(e)} id='nome' label='nome' variant='outlined' name='nome' margin='normal' fullWidth />
                        ...
                        <Typography className='subtitulo'>*Coloque apenas o link da foto nesse campo</Typography>
